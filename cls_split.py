...
X_valid = []
X_test = []
for pk_name in tqdm(pickle_list) :
...
with open(os.path.join('pk_dir/CP_train.pickle'), 'wb') as f:
    pickle.dump(X_train, f, protocol=pickle.HIGHEST_PROTOCOL)

with open(os.path.join('pk_dir/CP_valid.pickle'), 'wb') as f:
    pickle.dump(X_valid, f, protocol=pickle.HIGHEST_PROTOCOL)

with open(os.path.join('pk_dir/CP_test.pickle'), 'wb') as f:
